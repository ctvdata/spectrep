...
def featureExtractionStage() -> int:
    ...
    # Extraccion de vectores de ngramas de caracteres

    print('Extraccion de vectores de ngramas de caracteres')
    ...
    lv = vf.createCharBasedVectorizer(vw, cr, (2,5))

    print('Entrenando modelo de ngramas')
    lv.fit()
    ...
    lexicVectorLenght = lv.model.get_feature_names_out().shape[0]
    ...
    cr = Doc2VecCorpusReader('outputs/panPreprocessed_syn.jsonl')
    ...
    cr = Doc2VecCorpusReader('outputs/panPreprocessed_sem.jsonl')
